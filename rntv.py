...
def mat_search():
    #ПОИСК
    #BAD_WORDS = ['сука', 'хер', 'херня', 'дохера', 'нихера', 'херне', 'нахер', 'похер', 'нахера', 'нихуя' 'хуйня', 'похуй', 'долбоеб', 'хохол', 'чурка', 'хач']
    #BAD_WORDS = ['бля', 'сука', '*хер*', '*хуй*', 'долбоеб', 'хохол', 'чурка', 'хач']
    BAD_WORDS = ['бля', 'сука', 'хер', 'дохера', 'херн*',  'нихера', 'нахер*', 'похер*', '*хуй*', 'долбоеб', 'хохол', 'чурка', 'хач']
    READY_LIST = []
