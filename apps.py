...
def d2ru_violations(d2ru_category):
    ...
    'Консольные игры', 'League of Legends', 'MMO', 'Path of Exile', 'Shooter', 'Battle Royale', 'ККИ, Автобаттлеры', 'Hearthstone', 'Artifact', 'Dota Underlords'],
    'Основа' : ['Общие вопросы и обсуждения', 'Обитель нытья',
    'Dota Plus, компендиумы и ивенты', 'Обновления и патчи', 'Рейтинговая система и статистика', 'Герои: общие обсуждения',
    'Dream Dota', 'Нестандартные сборки', 'Киберспорт: общие обсуждения',
    'Игроки и команды', 'Турниры, матчи и прогнозы', 'Поиск игроков для ммр и паб игр',
    'Поиск игроков для создания команды', 'Поиск команды для совместных игр и участия в турнирах', 'Поиск игроков для ивентов и абузов',
