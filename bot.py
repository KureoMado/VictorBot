...
async def on_ready():
    ...
    time.sleep(2)
    await channel.send('И еще кое что, я тестю передачу сообщений в бд, так что бот будет сохранять всю историю сообщений. Но если вы вдруг против, то поставьте <:HZ:672538535781335045> под этот пост и я не буду записывать что вы пишете.')
